...
CURATOR_REVIEW_PROMPT = (
    ...
    "    When creating a new umbrella skill, pass `decision_context` with:\n"
    "      - diagnosis: which sibling cluster triggered this umbrella's creation\n"
    "      - evidence: which skills are being absorbed\n"
    "      - outcome: \"accept\"\n"
